...
import com.njupt.springframework.aop.InstantiationAwareBeanPostProcessor;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    private Object resolveBeforeInstantiation(String beanName, BeanDefinition beanDefinition) {
        ...
        // 跳过属性填充、beforeInitialization、init-method、initializingBean
        if (bean != null) {
    ...
    public Object applyBeanPostProcessorsBeforeInstantiation(Class<?> beanClass, String beanName) throws BeansException {
        ...
        // 取出所有InstantiationAwareBeanPostProcessor
